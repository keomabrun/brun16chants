...
\thomas{the map contains 16 motes in the orchard. Please update all text and tables to match to that: 16 motes in the orchard and 3 repeaters, 21 total.}
...
In 3~months of operation, we gathered over 4~million temperature values\thomas{you say 2M in the abstract. Which one is it?}, and more than 350,000~network statistics.
