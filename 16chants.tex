...
Those RSSI values are average values over the 16 channels defined in the IEEE 802.15.4 standard~\cite{std_ieee802154_2011}.
...
\keoma{TODO: add day/night colors on graph}
\begin{figure}
    \centering
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{fake}
    \caption{RSSI comparison in both direction with the same pare of node.}
    \label{fig:rssi_asymmetry}
\end{figure}
